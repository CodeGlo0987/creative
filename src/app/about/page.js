        ...
        <div className="container-work">
          <div className="content-work">
            <div className="image-section-work">
              <img
                alt="Top view of a group of people working on laptops and notebooks around a wooden table, with their fists joined together in the center."
                src="file:///C:/work/project/Public/im.jpeg"
              />
            </div>
            <div className="text-section-work">
              <h1>We Work With 5 Years Of Experience</h1>
              <p>
                Karachi Digital Marketing Agency provides comprehensive digital
                marketing solutions to businesses across industries with
                tailored and competitive strategies.
              </p>
              <p>
                Karachi Digital Marketing boasts a team of creative, technical
                and strategic experts. We ensure our clients with smooth
                campaign developments and custom web solutions that empower
                their business digitally.
              </p>
              <p>
                Expand your reach in the digital world with KDM Agency’s full
                spectrum of growth-oriented marketing solutions.
              </p>
...
============================= */}
      ...
      <div className="our-design">
        ...
        <div className="tools-design">
          <img
            alt="Sketch logo"
            src="file:///C:/work/project/Public/a-1.webp"
          />
          <img
            alt="InVision logo"
            src="file:///C:/work/project/Public/a-2.webp"
          />
          <img
            alt="Adobe After Effects logo"
            src="file:///C:/work/project/Public/a-3.webp"
          />
          <img alt="Figma logo" src="file:///C:/work/project/Public/a-4.webp" />
          <img
            alt="Adobe XD logo"
            src="file:///C:/work/project/Public/a-5.webp"
          />
          <img
            alt="Affinity Designer logo"
            src="file:///C:/work/project/Public/a-6.webp"
          />
        </div>
